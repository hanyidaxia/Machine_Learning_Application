...
library(scorecard)
diyi = fread.csv(coffee_test)
install.packages("table1")
library(table1)
diyi <- fread(coffee_test.csv)
diyi = read.csv('coffee_test.csv', encoding = UTF-8)
diyi = read.csv('coffee_test.csv')
